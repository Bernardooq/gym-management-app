document.addEventListener("DOMContentLoaded", function() {
    ...
    const cancelRBtn = document.getElementById("cancelRBtn");
        ...
        fetch(`http://localhost:3000/users/name/${searchTerm}`)
            ...
            .then(users => {
                ...
                users.forEach(user => {
                    ...
                    // Evento para desiluminar el div cuando el mouse sale
    ...
    addExerciseBtn.addEventListener("click", function() {
        ...
        fetch(`http://localhost:3000/exercises/find/${exerciseName}`)
            ...
            <br><div class="routine-item" style="display: flex; justify-content: space-between;">
                ...
                <button type="button" class="btn btn-danger delete-button" data-index="${routines.length-1}"><i class="fas fa-trash"></i></button>
            </div><br>
            `;
    ...
    cancelRBtn.addEventListener("click", function() {
        exerciseSearch.value = "";
        document.getElementById("series").value = "";
        document.getElementById("reps").value = "";
        sessionStorage.setItem("rutine", JSON.stringify([]));
