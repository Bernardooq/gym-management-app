        ...
        .then(clasesData =>{
            ...
            let diasConClase = {
                ...
                clasesData.forEach(clase => {
                    const htmlCode = `
                    <div class="card p-3 border border-dark position-relative" style="background-color: rgba(140, 50, 240)">
                        <button type="button" class="btn btn-light deleteClassBtn position-absolute top-1 end-0" data-id=`+clase._id+` style="position: relative; right: 4px;">
            ...
            for(let dia in diasConClase){
                if(!diasConClase[dia]){
                    ...
                    divDay.innerHTML += '<div class="card p-3 border border-dark" style="background-color: rgba(157, 63, 266)">No hay clases</div>';
                }
            }
