...
function loadExercises() {
    ...
    setTimeout(() => {
        ...
        .then(exercises => {
            ...
            exerciseRow.classList.add("row", "row-cols-1", "row-cols-lg-2", "g-3");

            exercises.forEach(exercise => {
                const cardCol = createExerciseCard(exercise);
                exerciseRow.appendChild(cardCol); // Agregar esta línea
            });
    ...
    function createExerciseCard(exercise) {
        ...
        cardCol.classList.add("col-lg-6", "mb-3");

        const card = document.createElement("div");
        card.classList.add("card", "p-3", "border-dark");
        ...
        exerciseName.style.color = "black"; // Color de texto Negro
        ...
        exerciseDetails.style.color = "white"; // Color de texto blanco
    
        const description = document.createElement("p");
        description.classList.add("text-center", "mb-2");
        description.textContent = `Descripción: ${exercise.description}`;
        description.style.color = "white"; // Color de texto blanco
        ...
        link.style.color = "white"; // Color de texto blanco
    
        const deleteButton = document.createElement("button");
        deleteButton.classList.add("btn", "btn-light", "me-2");
